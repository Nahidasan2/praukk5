...
bg_image = Image.open('kucing.png')
...
frame = tk.Frame(master=window, bg="blue", padx=10)
...
button_div.grid(row=5, column=0, pady=2, sticky="nsew")
button_clear = tk.Button(master=frame, text="c", padx=15, pady=5, width=3, font=(50), command=clear)
button_clear.grid(row=5, column=2, columnspan=1, pady=2, sticky="nsew")
button_equal = tk.Button(master=frame, text="=", padx=15, pady=5, width=9, font=(50), command=equal)
button_equal.grid(row=6, column=0, columnspan=2, pady=2, sticky="nsew")
